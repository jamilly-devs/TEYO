...
7. **Regras de negócio**: exclusão exige confirmação; conflito de horário sinalizado ao usuário antes de confirmar criação (ver `PLANNER.md`, A DEFINIR o comportamento exato).
